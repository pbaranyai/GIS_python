...
# Locator location
Locators = r"R:\\GIS\\CurrentWebsites\\Locators"
...
Draft_Staging = r"R:\\GIS\\CurrentWebsites\\Locators\\Draft_Services"

# Local variables:
CC_Roads_Locator = Locators + "\\Intranet_Locators\\CC_Roads_Locator"
CC_Parcel_Locator = Locators + "\\Intranet_Locators\\CC_Parcel_Locator"
CC_Name_Locator = Locators + "\\Intranet_Locators\\CC_Name_Locator"
CC_Address_Search = Locators + "\\Intranet_Locators\\CC_Address_Search"
BuildingOnly_UPI_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_UPI_CCLocator"
BuildingOnly_PID_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_PID_CCLocator"
BuildingOnly_Name_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_Name_CCLocator"
#BuildingOnly_MBLU_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_MBLU_CCLocator"
BuildingOnly_ADDR2_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_ADDR2_CCLocator"
BuildingOnly_ADDR1_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_ADDR1_CCLocator"
BuildingOnly_Control_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\BuildingOnly_Control_CCLocator"
TaxParcel_UPI_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_UPI_CCLocator"
TaxParcel_PID_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_PID_CCLocator"
TaxParcel_Name_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_Name_CCLocator"
TaxParcel_CAMA_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_CAMA_CCLocator"
TaxParcel_ADDR2_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_ADDR2_CCLocator"
TaxParcel_ADDR1_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_ADDR1_CCLocator"
TaxParcel_ALTPRCLID_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_ALTPRCLID_CCLocator"
TaxParcel_Control_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\TaxParcel_Control_CCLocator"
CL_Number_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\CL_Number_CCLocator"
CL_Name_CCLocator = Locators + "\\Intranet_Locators\\Locator_workspace\\CL_Name_CCLocator"
...
Crawford_Name_Locator = Locators + "\\Public_Locators\\Crawford_Name_Locator"
Crawford_Address_Search = Locators + "\\Public_Locators\\Crawford_Address_Search"
Crawford_Landmarks_Locator = Locators + "\\Public_Locators\\Crawford_Landmarks_Locator"
Crawford_Cemeteries_Locator = Locators + "\\Public_Locators\\Crawford_Cemeteries_Locator"
BuildingOnly_UPI_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_UPI_PubLocator"
BuildingOnly_PID_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_PID_PubLocator"
BuildingOnly_Name_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_Name_PubLocator"
#BuildingOnly_MBLU_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_MBLU_PubLocator"
BuildingOnly_ADDR2_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_ADDR2_PubLocator"
BuildingOnly_ADDR1_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_ADDR1_PubLocator"
BuildingOnly_Control_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\BuildingOnly_Control_PubLocator"
TaxParcel_UPI_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_UPI_PubLocator"
TaxParcel_PID_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_PID_PubLocator"
TaxParcel_Name_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_Name_PubLocator"
TaxParcel_CAMA_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_CAMA_PubLocator"
TaxParcel_ADDR2_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_ADDR2_PubLocator"
TaxParcel_ADDR1_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_ADDR1_PubLocator"
TaxParcel_ALTPRCLID_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_ALTPRCLID_PubLocator"
TaxParcel_Control_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\TaxParcel_Control_PubLocator"
CL_Number_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\CL_Number_PubLocator"
CL_Name_PubLocator = Locators + "\\Public_Locators\\Locator_workspace\\CL_Name_PubLocator"
...
print ("\n Rebuilding ADDR_PriAdd Locator - Public")
write_log("\n Rebuilding ADDR_PriAdd Locator - Public", logfile)

try:
    # Rebuild ADDR_PriAdd Locator from Address_Points - PUBLIC_WEB
    arcpy.RebuildAddressLocator_geocoding(ADDR_PriAdd_PubLocator)
except:
    print ("\n Unable to rebuild ADDR_PriAdd Locator from Address_Points - PUBLIC_WEB")
    write_log("\n Unable to rebuild ADDR_PriAdd Locator from Address_Points - PUBLIC_WEB", logfile)
    logging.exception('Got exception on rebuild ADDR_PriAdd Locator from Address_Points - PUBLIC_WEB logged at:' + str(Day) + " " + str(Time))
    raise
    sys.exit ()

print ("       Rebuilding ADDR_PriAdd Locator from Address_Points - PUBLIC_WEB completed")
write_log("       Rebuilding ADDR_PriAdd Locator from Address_Points - PUBLIC_WEB completed", logfile)

print ("\n Rebuilding CL_Name Locator - Public")
write_log("\n Rebuilding CL_Name Locator - Public", logfile)

try:
    # Rebuild CL_Name Locator from Street Centerline - PUBLIC_WEB
    arcpy.RebuildAddressLocator_geocoding(CL_Name_PubLocator)
except:
    print ("\n Unable to rebuild CL_Name Locator from Street Centerline - PUBLIC_WEB")
    write_log("\n Unable to rebuild CL_Name Locator from Street Centerline - PUBLIC_WEB", logfile)
    logging.exception('Got exception on rebuild CL_Name Locator from Street Centerline - PUBLIC_WEB logged at:' + str(Day) + " " + str(Time))
    raise
    sys.exit ()

print ("       Rebuilding CL_Name Locator from Street Centerline - PUBLIC_WEB completed")
write_log("       Rebuilding CL_Name Locator from Street Centerline - PUBLIC_WEB completed", logfile)

print ("\n Rebuilding CL_Number Locator from Street Centerline - PUBLIC_WEB")
write_log("\n Rebuilding CL_Number Locator - Public", logfile)

try:
    # Rebuild CL_Number Locator
    arcpy.RebuildAddressLocator_geocoding(CL_Number_PubLocator)
except:
    print ("\n Unable to rebuild CL_Number Locator from Street Centerline - PUBLIC_WEB")
    write_log("\n Unable to rebuild CL_Number Locator from Street Centerline - PUBLIC_WEB", logfile)
    logging.exception('Got exception on rebuild CL_Number Locator from Street Centerline - PUBLIC_WEB logged at:' + str(Day) + " " + str(Time))
    raise
    sys.exit ()

print ("       Rebuilding CL_Number Locator from Street Centerline - PUBLIC_WEB completed")
write_log("       Rebuilding CL_Number Locator from Street Centerline - PUBLIC_WEB completed", logfile)
...
##print ("\n Rebuilding BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB")
##write_log("\n Rebuilding BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB", logfile)
##
##try:
##    # Rebuild BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB
##    arcpy.RebuildAddressLocator_geocoding(BuildingOnly_MBLU_PubLocator)
##except:
##    print ("\n Unable to rebuild BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB")
##    write_log("\n Unable to rebuild BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB", logfile)
##    logging.exception('Got exception on rebuild BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB logged at:' + str(Day) + " " + str(Time))
##    raise
##    sys.exit ()
##
##print ("       Rebuilding BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB completed")
##write_log("       Rebuilding BuildingOnly_MBLU Locator from Building/Trailer Only - PUBLIC_WEB completed", logfile)
...
##
##print ("\n Rebuilding Crawford Roads Locator from individual locators")
##write_log("\n Rebuilding Crawford Roads Locator from individual locators", logfile)
##
##try:
##    # Rebuild Crawford Roads Locator from individual locators
##    arcpy.RebuildAddressLocator_geocoding(Crawford_Roads_Locator)
##except:
##    print ("\n Unable to rebuild Crawford Roads Locator from individual locators")
##    write_log("\n Unable to rebuild Crawford Roads Locator from individual locators", logfile)
##    logging.exception('Got exception on rebuild Crawford Roads Locator from individual locators logged at:' + str(Day) + " " + str(Time))
##    raise
##    sys.exit ()
##
##print ("       Rebuilding Crawford Roads Locator from individual locators completed")
##write_log("       Rebuilding Crawford Roads Locator from individual locators completed", logfile)
...
print ("\n Rebuilding ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL")
write_log("\n Rebuilding ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL", logfile)

try:
    # Rebuild ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL
    arcpy.RebuildAddressLocator_geocoding(ADDR_PriAdd_CCLocator)
except:
    print ("\n Unable to rebuild ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL")
    write_log("\n Unable to rebuild ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL", logfile)
    logging.exception('Got exception on rebuild ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL logged at:' + str(Day) + " " + str(Time))
    raise
    sys.exit ()

print ("       Rebuilding ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL completed")
write_log("       Rebuilding ADDR_PriAdd_INTRA locator from Address_Points - CRAW_INTERNAL completed", logfile)
...
try:
    # CL_Name_INTRA Locator from Street Centerline - CRAW_INTERNAL
    arcpy.RebuildAddressLocator_geocoding(CL_Name_CCLocator)
except:
    print ("\n Unable to rebuild CL_Name_INTRA Locator from Street Centerline - CRAW_INTERNAL")
    write_log("\n Unable to rebuild CL_Name_INTRA Locator from Street Centerline - CRAW_INTERNAL", logfile)
    logging.exception('Got exception on rebuild CL_Name_INTRA Locator from Street Centerline - CRAW_INTERNAL logged at:' + str(Day) + " " + str(Time))
    raise
    sys.exit ()

print ("       Rebuilding CL_Name_INTRA Locator from Street Centerline - CRAW_INTERNAL completed")
write_log("       Rebuilding CL_Name_INTRA Locator from Street Centerline - CRAW_INTERNAL completed", logfile)

print ("\n Rebuilding CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL")
write_log("\n Rebuilding CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL", logfile)

try:
    # Rebuild CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL
    arcpy.RebuildAddressLocator_geocoding(CL_Number_CCLocator)
except:
    print ("\n Unable to rebuild CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL")
    write_log("\n Unable to rebuild CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL", logfile)
    logging.exception('Got exception on rebuild CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL logged at:' + str(Day) + " " + str(Time))
    raise
    sys.exit ()

print ("       Rebuilding CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL completed")
write_log("       Rebuilding CL_Number_INTRA Locator from Street Centerline - CRAW_INTERNAL completed", logfile)
...
##print ("\n Rebuilding BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL")
##write_log("\n Rebuilding BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL", logfile)
##
##try:
##    # Rebuild BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL
##    arcpy.RebuildAddressLocator_geocoding(BuildingOnly_MBLU_CCLocator)
##except:
##    print ("\n Unable to rebuild BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL")
##    write_log("\n Unable to rebuild BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL", logfile)
##    logging.exception('Got exception on rebuild BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL logged at:' + str(Day) + " " + str(Time))
##    raise
##    sys.exit ()
##
##print ("       Rebuilding BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL completed")
##write_log("       Rebuilding BuildingOnly_MBLU_INTRA Locator from Building/Trailer Only - CRAW_INTERNAL completed", logfile)
...
##
##print ("\n Rebuilding CC Roads Locator from individual locators")
##write_log("\n Rebuilding CC Roads Locator from individual locators", logfile)
##
##try:
##    # Rebuild CC Roads Locator from individual locators
##    arcpy.RebuildAddressLocator_geocoding(CC_Roads_Locator)
##except:
##    print ("\n Unable to rebuild CC Roads Locator Locator from individual locators")
##    write_log("Unable to rebuild CC Roads Locator Locator from individual locators", logfile)
##    logging.exception('Got exception on rebuild CC Roads Locator Locator from individual locators logged at:' + str(Day) + " " + str(Time))
##    raise
##    sys.exit ()
##
##print ("       Rebuilding CC Roads Locator Locator from individual locators completed")
##write_log("       Rebuilding CC Roads Locator Locator from individual locators completed", logfile)
