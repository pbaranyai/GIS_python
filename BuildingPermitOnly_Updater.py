...
try:
    ...
    arcpy.management.Append(BUILDING_PERMIT_JOINED_AUTOWKSP, BUILDING_PERMITS_INTERNAL, "NO_TEST", r'REM_PID "PID Number" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PID,-1,-1;REM_PID_1 "PID Number" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PID_1,-1,-1;REM_PIN "UPI Number" true true false 35 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PIN,0,35;REM_OWN_NAME "Owner Name" true true false 85 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_OWN_NAME,0,85;REM_PRCL_LOCN "Parcel Location" true true false 50 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PRCL_LOCN,0,50;REM_PRCL_LOCN_CITY "Parcel Location City" true true false 18 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PRCL_LOCN_CITY,0,18;REM_PRCL_LOCN_STT "Parcel Location State" true true false 2 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PRCL_LOCN_STT,0,2;REM_PRCL_LOCN_ZIP "Parcel Location Zipcode" true true false 12 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PRCL_LOCN_ZIP,0,12;REM_ALT_PRCL_ID "Old IBM Number" true true false 35 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_ALT_PRCL_ID,0,35;REM_PRCL_STATUS_DATE "Parcel Status date - CAMA Software" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_PRCL_STATUS_DATE,-1,-1;REM_MBLU_MAP "Map" true true false 7 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_MAP,0,7;REM_MBLU_MAP_CUT "Map Cut - Not Used" true true false 3 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_MAP_CUT,0,3;REM_MBLU_BLOCK "Block" true true false 7 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_BLOCK,0,7;REM_MBLU_BLOCK_CUT "Block Cut - Not Used" true true false 3 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_BLOCK_CUT,0,3;REM_MBLU_LOT "Lot" true true false 7 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_LOT,0,7;REM_MBLU_LOT_CUT "Lot Cut - Not Used" true true false 3 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_LOT_CUT,0,3;REM_MBLU_UNIT "Unit" true true false 7 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_UNIT,0,7;REM_MBLU_UNIT_CUT "Unit Cut - Not Used" true true false 3 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_MBLU_UNIT_CUT,0,3;REM_STATUS_DATE "Status Date - CAMA software" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_STATUS_DATE,-1,-1;REM_INET_SUPPRESS "Internet Suppression" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_INET_SUPPRESS,-1,-1;REM_IS_CONDO_MAIN "Is Condo Main Parcel" true true false 2 Short 0 5,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_IS_CONDO_MAIN,-1,-1;REM_CMPLX_NAME "Complex Name" true true false 30 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_CMPLX_NAME,0,30;REM_BLDG_NAME "Acreage and Description" true true false 60 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_BLDG_NAME,0,60;REM_USE_CODE "Use Code" true true false 4 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_USE_CODE,0,4;REM_LEGAL_AREA "Legal Area" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_LEGAL_AREA,-1,-1;REM_LAST_UPDATE "Last Update - CAMA software" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_LAST_UPDATE,-1,-1;REM_USRFLD "6 digit PID" true true false 6 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_USRFLD,0,6;REM_USRFLD_DESC "Control Number" true true false 40 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',REM_USRFLD_DESC,0,40;PID_TEXT "PID Text format" true true false 15 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PID_TEXT,0,15;LND_USE_CODE "Land Use Code" true true false 4 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',LND_USE_CODE,0,4;LND_USE_DESC "Land Use Description" true true false 40 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',LND_USE_DESC,0,40;LND_DSTRCT "District Number" true true false 6 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',LND_DSTRCT,0,6;PRC_PF_LOCN "School District Code" true true false 15 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_PF_LOCN,0,15;PRC_PF_LOCN_DESC "School District" true true false 50 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_PF_LOCN_DESC,0,50;PRC_USRFLD_09 "User Field 9 - Not Used" true true false 30 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_USRFLD_09,0,30;PRC_USRFLD_10 "User Field 10 - Not Used" true true false 30 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_USRFLD_10,0,30;PRC_TTL_ASSESS_BLDG "Total Building Assessment" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_TTL_ASSESS_BLDG,-1,-1;PRC_TTL_ASSESS_IMPROVEMENTS "Total Improvements Assessment" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_TTL_ASSESS_IMPROVEMENTS,-1,-1;PRC_TTL_ASSESS_LND "Total Land Assessment" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_TTL_ASSESS_LND,-1,-1;PRC_TTL_ASSESS_OB "Total Out Building Assessment" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_TTL_ASSESS_OB,-1,-1;PRC_VALUE "Parcel Value" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_VALUE,-1,-1;PRC_CMPLX_PID "Complex PID" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_CMPLX_PID,-1,-1;PRC_CMPLX_DESC "Complex Description" true true false 30 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_CMPLX_DESC,0,30;PRC_CENSUS "Census - Not Used" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_CENSUS,0,20;PRC_TTL_MRKT_ASSESS "Total Market Assessment" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_TTL_MRKT_ASSESS,-1,-1;PRC_TTL_ASSESS "Total Assessment" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',PRC_TTL_ASSESS,-1,-1;OWN_NAME1 "OWN_NAME1" true true false 85 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',OWN_NAME1,0,85;OWN_NAME2 "OWN_NAME2" true true false 85 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',OWN_NAME2,0,85;ROW_PID "ROW_PID" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',ROW_PID,-1,-1;ROW_OWN_PCT "ROW_OWN_PCT" true true false 2 Short 0 5,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',ROW_OWN_PCT,-1,-1;MAD_MAIL_NAME1 "Tax Bill Mailing Address Name 1" true true false 85 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_NAME1,0,85;MAD_MAIL_NAME2 "Tax Bill Mailing Address Name 2" true true false 85 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_NAME2,0,85;MAD_MAIL_ADDR1 "Tax Bill Mailing Address 1" true true false 50 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_ADDR1,0,50;MAD_MAIL_CITY "Tax Bill Mailing Address City" true true false 30 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_CITY,0,30;MAD_MAIL_STATE "Tax Bill Mailing Address State" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_STATE,0,20;MAD_MAIL_ZIP "Tax Bill Mailing Address Zipcode" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_ZIP,0,20;MAD_MAIL_ADDR2 "Tax Bill Mailing Address 2" true true false 50 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MAD_MAIL_ADDR2,0,50;SLH_PID "Sales History PID" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',SLH_PID,-1,-1;SLH_SALE_DATE "Sale Date" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',SLH_SALE_DATE,-1,-1;SLH_BOOK "Deed Book / Instrument Number" true true false 15 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',SLH_BOOK,0,15;SLH_PAGE "Deed Page" true true false 15 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',SLH_PAGE,0,15;SLH_PRICE "Sale Price" true true false 8 Double 8 38,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',SLH_PRICE,-1,-1;BPE_PID "Building Permit PID Number" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_PID,-1,-1;BPE_PERMIT_ID "Permit ID" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_PERMIT_ID,0,20;BPE_FISCAL_YR "Permit Fiscal Year" true true false 2 Short 0 5,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_FISCAL_YR,-1,-1;BPE_APP_DATE "Permit Application Date" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_APP_DATE,-1,-1;BPE_ISSUE_DATE "Permit Issue Date" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_ISSUE_DATE,-1,-1;BPE_INSPECT_DATE "Permit Inspection Date" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_INSPECT_DATE,-1,-1;BPE_AMOUNT "Permit Amount" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_AMOUNT,-1,-1;BPE_FEE "Permit Fee" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_FEE,-1,-1;BPE_APPLICANT "Permit Applicant" true true false 50 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_APPLICANT,0,50;BPE_LICENCE "Permit License" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_LICENCE,0,20;BPE_COMPANY "Permit Company" true true false 50 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_COMPANY,0,50;BPE_AREA "Permit Area" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_AREA,0,20;BPE_REF "Permit Reference" true true false 20 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_REF,0,20;BPE_DESC "Permit Description" true true false 40 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_DESC,0,40;BPE_PCT_COMPLETE "Permit Percent Complete" true true false 4 Long 0 10,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_PCT_COMPLETE,-1,-1;BPE_DATE_COMPLETE "Permit Date Complete" true true false 8 Date 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_DATE_COMPLETE,-1,-1;BPE_COMMENT "Permit Comment" true true false 750 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_COMMENT,0,750;BPE_USRFLD_01 "Was permit issued by Municipality?" true true false 100 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_USRFLD_01,0,100;BPE_USRFLD_02 "Permit User Field 2 (Not used)" true true false 100 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_USRFLD_02,0,100;BPE_USRFLD_03 "Permit User Field 3 (Not used)" true true false 100 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_USRFLD_03,0,100;BPE_USRFLD_04 "Permit User Field 4 (Not used)" true true false 100 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_USRFLD_04,0,100;BPE_USRFLD_05 "Permit User Field 5 (Not used)" true true false 100 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',BPE_USRFLD_05,0,100;MUNI_NAME "Municipality Name" true true false 75 Text 0 0,First,#,'+BUILDING_PERMIT_JOINED_AUTOWKSP+',MUNI_NAME,0,75;GlobalID "GlobalID" false false true 38 GlobalID 0 0,First,#', '', '')
